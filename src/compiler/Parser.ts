...
import { ParseOperand, SingleOperand } from "./Parser/ParseOperand";
...
export class Parser
{
    ...
    private currentCondition: ParseCondition | null = null;
    ...
    match(tokenType: TokenType, tokenValue: string | null = null)
    {
    ...
    assert(tokenType: TokenType, tokenValue: string | null = null): Token
    {
    ...
    parseIfStatement()
    {
        ...
        const ifTrueBlock: ParseType[] = [];
        const ifFalseBlock: ParseType[] = [];
        let processTrue: boolean = true;
